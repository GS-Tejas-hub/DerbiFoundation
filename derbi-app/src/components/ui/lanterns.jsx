...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Apply the Royal Gold aesthetics color mapping to the output
    // The original uses tanh for color curve. We'll map it to warm gold/orange hues.
    vec4 baseColor = tanh(vec4(9.0, 3.0, 1.0, 0.0) * o / 6e3);
    
    // Slight color grading for the "Pitch Black and Royal Gold" theme
    vec3 royalGold = vec3(0.83, 0.68, 0.21); // approximation of #D4AF37
    fragColor = vec4(baseColor.r * royalGold.r * 1.5, baseColor.g * royalGold.g * 1.5, baseColor.b * royalGold.b * 0.8, 1.0);
}
...
export function ShaderCanvas({ fragSource = SHADER_SRC, pixelRatio }) {
