...
pages.forEach(({ file, name }) => {
    ...
    const content = [
        ...
        "import SEO from '" + relativePrefix + "components/SEO';",
        "",
        "const " + componentName + " = () => {",
        "  return (",
        ...
        "      <SEO ",
        "        title=\"" + name + "\"",
        "        description=\"Explore the " + name + " page of Derbi Foundations, where innovation meets majestic design.\"",
        "        keywords=\"" + name.toLowerCase() + ", derbi, startups, innovation\"",
        "      />",
        "      ",
        ...
        "          Welcome to the absolute premium <strong className=\"text-royal-gold-light font-medium\">" + name + "</strong> experience.",
